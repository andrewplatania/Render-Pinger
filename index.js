...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .url-link { font-family: "SF Mono", "Fira Code", monospace; font-size: 18px; color: var(--text); text-decoration: none; word-break: break-all; }
    ...
    .protocol-select { font-family: "SF Mono", "Fira Code", monospace; font-size: 13px; color: var(--muted); background: var(--surface2); border: 1px solid var(--border); border-radius: 8px 0 0 8px; padding: 9px 10px; white-space: nowrap; border-right: none; outline: none; cursor: pointer; appearance: none; -webkit-appearance: none; }
    .protocol-select option { background: var(--surface2); color: var(--text); }
...
<body>
  ...
  <div class="add-section">
    <h2>Add service</h2>
    <div class="add-row">
      <select id="protocol" class="protocol-select"><option value="https://">https://</option><option value="http://">http://</option></select>
  ...
  <script>
    async function addService() {
      ...
      const url = protocol + document.getElementById('newUrl').value.trim();
